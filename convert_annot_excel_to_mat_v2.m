...
init_fields = {'movie', 'fly', 'L_t0s', 'L_t1s', 'L_scores', 'L_combined_score', 'L_annotators'...
    'HB_t0s', 'HB_t1s', 'HB_scores', 'HB_combined_score', 'HB_annotators', 'WE_t0s', 'WE_t1s', ...
    'WE_scores', 'WE_combined_score', 'WE_annotators'};
...
save('FLYMAT_HumanAnnotation_new.mat', 'flymatHumanAnnot');